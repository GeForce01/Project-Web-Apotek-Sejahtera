                                ...
                                <div class="card card-chart">
                                    <div class="card-header ">
                                        <?php
                                            ...
                                            $utama = "SELECT * FROM `users`";
                                            $cek_utama = mysqli_query($kon, $utama);
                                            while($user = mysqli_fetch_array($cek_utama)){
                                        ...
                                        ?>
                                            <div class="row">
                                                <div class="col-sm-6 text-left">
                                                    ...
                                                    <h2 class="card-title">
                                                        <?php echo $cek_utama['nama']?> diadmin </h2>
                                                </div>
                                            </div>
                                        <?php
                                        }
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12 col-xs-12">
                                                    ...
                                                    $tampil = "SELECT * FROM `komen` ORDER BY `waktu_komen`DESC LIMIT 99";
                                                    $pesan = mysqli_query($kon, $tampil);
                                                                ...
                                                                <ul class="chat-box">
                                                                    <li class="right clearfix">
                                                                        <div class="chat-body clearfix">
                                                                            ...
                                                                            <i class="fa fa-clock-o fa-fw"></i><?php echo $hasil['waktu_komen']?></i></small>
                                                                            <strong class="pull-right"><?php echo $hasil['nama_komen']?></strong>
