                ...
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    <div class="col-md-12">
                          <div class="row">
                          <div class="card-body">
                            <form action="./proses/edit2.php" method="POST" enctype="multipart/form-data" id="inputdata">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" name="nama" type="text" placeholder="Nama Lengkap" value="<?php echo $data['nama']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Alamat</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" name="alamat" placeholder="Alamat Lengkap" type="text" value="<?php echo $data['alamat']; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                          <select class="form-select form-control" aria-label="Default select example" name="gender" id="Gender" >
                                            <option <?php echo ($data['gender']=='pilihan status') ? "selected":""?>>Pilih Status</option>
                                            <option <?php echo ($data['gender']=='laki-laki') ? "selected":""?>>Laki-laki</option>
                                            <option <?php echo ($data['gender']=='perempuan') ? "selected":""?>>Perempuan</option>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" name="no_hp" placeholder="Alamat Lengkap" type="text" value="<?php echo $data['no_hp']; ?>">
                                    </div>
                                </div>
