                ...
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    <div class="col-md-12">
                          <div class="row">
                          <div class="card-body">
                            <form action="proses-tambah.php" method="POST" enctype="multipart/form-data" id="inputdata">
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Nama</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" name="nama" type="text" placeholder="Nama Anda" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">No Hp</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control" name="no_hp" placeholder="Number Telepon" type="text" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Alamat</label>
                                    <div class="col-sm-12 col-md-10">
                                        <input class="form-control date-picker" name="alamat" placeholder="Alamat anda" type="text" required>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-12 col-md-2 col-form-label">Gender</label>
                                        <div class="col-sm-12 col-md-10">
                                          <select class="form-select form-control" aria-label="Default select example" name="gender" id="Gender" required>
                                            <option selected>Pilih jenis kelamin</option>
                                            <option value="laki-laki" for="Gender" >Laki-laki</option>
                                            <option value="perempuan" for="Gender">Perempuan</option>
                                          </select>
                                        </div>
                                    </div>
